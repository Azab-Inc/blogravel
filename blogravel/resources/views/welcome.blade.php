...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="flex items-center justify-center min-h-screen bg-gray-50">
        <div class="text-center">
            ...
            <a href="{{ route('filament.admin.pages.dashboard') }}" class="inline-block mt-6 px-6 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800">Admin</a>
        </div>
    </body>
</html>
